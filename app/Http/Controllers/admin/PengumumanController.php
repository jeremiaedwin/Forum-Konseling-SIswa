...
class PengumumanController extends Controller
{
    public function index(){
        ...
        return view('admin/pengumuman/index',['kel_pengumuman' => $kel_pengumuman]);
    }
    ...
    public function create(){
        ...
        return view('admin/pengumuman/buat_pengumuman',compact('catepegus','statuses'));
    }
    ...
    public function edit_pengumuman($slug){
        ...
        return view('admin/pengumuman/edit_pengumuman',['kel_pengumuman' => $kel_pengumuman],compact('catepegus','statuses'));
    ...
    public function show_pengumuman($slug){
        ...
        return view('admin/pengumuman/show',['kel_pengumuman' => $kel_pengumuman]);
    }
