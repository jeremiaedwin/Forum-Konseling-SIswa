    ...
    <div class="card">
        ...
        {{csrf_field()}}
            ...
            <div class="col-3">
                ...
                <a href="/admin/rekap/reportpostpdf"  class="btn btn-primary btn-sm mt-2">Cetak PDF</a>
            ...
            <div class="row m-3">
                <div class="col-md-12">
                <center><strong><h5>Rekap Report Post Bulan {{$monthName}} Tahun {{date('Y')}}</h5></strong></center>
