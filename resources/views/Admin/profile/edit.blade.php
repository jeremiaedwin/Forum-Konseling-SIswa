...
<form action="/admin/profile/{{$profiles->id}}" method="post" enctype="multipart/form-data">
{{csrf_field()}}
{{method_field('PUT')}}
<div class="row">
    <div class="col-md-4">
        <div class="card card-content">
            <div class="card-body">
                ...
                <a href="/admin/profile/{{$profiles->id}}" class="btn btn-primary btn-block mt-3">Kembali</a>
                </div>
            </div>
        </div>
    </div>
