            ...
            <div class="col-md-4" id="userList">
                <div id="accordion">
                    <div class="card">
                        ...
                        <h5 class="mb-0">
                            <button class="btn btn-block" style="background-color: none; color:white; font-weight:bold" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                            <span><i class="fas fa-user"></i> Chat Dengan Siswa</span>
                            </button>
                        </h5>
                        </div>
                        ...
                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                            ...
                            <div class="card m-2" height="400px" style="overflow:auto">
                                ...
                                <div class="media mb-3">
                                    <img class="align-self-start mr-3" src="{{ asset('image/'. $user->foto_profil) }}" width="64" heigh="64" alt="Generic placeholder image">
...
$(document).ready(function(){
    ...
    $(document).on('keyup', '.input-message input', function (e) {
        ...
        if (e.keyCode == 13 && message != '' && receiver_id != '') {
            ...
            $.ajax({
                type: 'post',
                url: '/guru/message', // need to create this post route
                data: datastr,
                cache: false,
                success: function (data) {
...
$(document).ready(function(){
    ...
    $(document).on('keyup', '#search', function (e) {
        ...
        if (e.keyCode == 13 && name != '') {
            ...
            $.ajax({
                type: 'post',
                url: '/guru/message/searchsiswa', // need to create this post route
                data: datastr,
                cache: false,
                success: function (data) {
