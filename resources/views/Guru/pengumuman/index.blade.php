        ...
        <div class="row">
            <div class="col-md-12 mt-2">
                ...
                <h3>{{$pengumuman->title}}</h3>             
                  ...
                  @endif
                <a href="/guru/show_pengumuman/{{$pengumuman->slug}}" style="text-decoration : none"><p>Lanjutkan Membaca</p></a>
                <div class="mt-4">
                <!--
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-danger" href="/guru/delete_pengumuman/{{ $pengumuman->slug }}">Hapus</a>
        </div>
      </div>
    </div>
  </div>
