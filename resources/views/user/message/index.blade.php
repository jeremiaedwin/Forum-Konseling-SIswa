                ...
                <div id="accordion">
                    <div class="card">
                        ...
                        <h5 class="mb-0">
                            ...
                            <span><i class="fas fa-user"></i> Chat Dengan Guru</span>
                            </button>
                        </h5>
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                @if($user->role == 'guru')
                                    <div class="media mb-3">
                                        <img class="align-self-start profile-pic mr-3" src="{{ asset('image/'. $user->foto_profil) }}" width="64" height="64" alt="Generic placeholder image">
